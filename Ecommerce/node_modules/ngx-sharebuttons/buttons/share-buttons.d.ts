...
export declare class ShareButtons implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ShareButtons, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ShareButtons, "share-buttons", never, { "theme": "theme"; "showIcon": "showIcon"; "showText": "showText"; "size": "size"; "include": "include"; "exclude": "exclude"; "show": "show"; "url": "url"; "title": "title"; "description": "description"; "image": "image"; "tags": "tags"; "autoSetMeta": "autoSetMeta"; "disabled": "disabled"; }, { "opened": "opened"; "closed": "closed"; }, never, never>;
}
export {};
/**
